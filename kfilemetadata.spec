...
Source0  : https://download.kde.org/stable/frameworks/6.4/kfilemetadata-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/kfilemetadata-6.4.0.tar.xz.sig
...
%setup -q -n kfilemetadata-6.4.0
cd %{_builddir}/kfilemetadata-6.4.0
pushd ..
cp -a kfilemetadata-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720822404
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF6FileMetaData.so.6.4.0
...
/usr/lib64/libKF6FileMetaData.so.6.4.0
